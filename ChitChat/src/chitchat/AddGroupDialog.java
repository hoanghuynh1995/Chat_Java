...
public class AddGroupDialog extends javax.swing.JFrame {
    ...
    public AddGroupDialog(MainUI mainUI) {
        initComponents();
        this.mainUI = mainUI;
    }
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(tfMembers);

        jLabel3.setText("(Separated by space)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(tfName.getText().equals("") || tfMembers.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Please fill in the blanks!!");
            return;
        }
        mainUI.addGroupRequest(new ArrayList(Arrays.asList(tfMembers.getText().split(" "))),tfName.getText());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddGroupDialog(mainUI).setVisible(true);
            }
        });
    }
